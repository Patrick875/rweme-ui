  ...
  <div>
    <div>
      <Table
        :data="foodRequests"
        :title="'Feed Requests'"
        :length="String(foodRequests.length)"
        :handle-table-search="handleSearch"
        :handleViewDetails="openFoodRequest"
        :open-filter="openFilter"
        :reset-filter="resetFilter"
        :handlePrimaryButtonClicks="() => (isCreateFoodRequest = true)"
        :user-can-delete="false"
        :btn-name="isSupplier ? '' : 'Submit food Request'"
        :columns="!isSupplier ? columns : supplierColums"
        :handle-export="exportToExcell"
      />
      <FoodRequestModal
        :cancelButton="() => (isCreateFoodRequest = false)"
        :isToggleFoodRequestModal="isCreateFoodRequest"
      ></FoodRequestModal>
      <FoodRequestDetailsModal
        ...
        :loading="loading"
        :openComfirmationModal="() => (isComfirmRequestReception = true)"
        :foodRequest="viewableFoodRequest.value"
      >
      </FoodRequestDetailsModal>

      <Modal
        :isOpen="isComfirmRequestReception"
        @modal-close="() => (isComfirmRequestReception = false)"
        mainHeader="COMFIRM FOOD RECEPTION"
        subHeader=""
