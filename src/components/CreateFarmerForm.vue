        ...
        <a-row :gutter="16">
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Full Name" name="fullName" :rules="[
              ...
              <a-input class="input" placeholder="Please enter farmer full name" v-model:value="farmerForm.fullName" />
            </a-form-item>
          </a-col>
          <a-col :span="isSmallScreen ? 24 : 12">
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Email Address" name="email"
              ...
              <a-input class="input" type="email" placeholder="Enter a valid email" v-model:value="farmerForm.email" />
            </a-form-item>
          </a-col>
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="National Id" name="nationalId" :rules="[
              ...
              <a-input class="input" placeholder="Enter a valid national Id" v-model:value="farmerForm.nationalId" />
            </a-form-item>
          </a-col>
          <a-col :span="isSmallScreen ? 24 : 12">
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="District" name="districtId"
              :rules="[{ required: true, message: 'Please input select !!' }]">
              <a-select :disabled="!farmerForm.provinceId" v-model:value="farmerForm.districtId" :size="'middle'"
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Sector" name="sectorId"
              :rules="[{ required: true, message: 'Please input select !!' }]">
              <a-select :disabled="!farmerForm.districtId" v-model:value="farmerForm.sectorId" :size="'middle'"
                placeholder="Please select !!" @popupScroll="popupScroll">
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Type of Chicken" name="chickenTypeId" :rules="[
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Chicken health condition" name="chickenHealthCondition"
              :rules="[
                { required: true, min: 1, message: 'Please input select !!' },
              ]">
              <a-select v-model:value="farmerForm.chickenHealthCondition" :size="'middle'" placeholder="Please select"
                @popupScroll="popupScroll">
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Assigned Veternary" name="assignedTo"
              ...
              <a-select v-model:value="farmerForm.assignedTo" :size="'middle'" placeholder="Please select">
                ...
                <a-select-option v-for="vet in veternaries" :value="vet.key" :key="vet.key">{{ vet.fullName + " / " +
                  vet.telephone }}
                </a-select-option>
              </a-select>
            </a-form-item>
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item name="typeOfFeed" label="Select type of Feed" has-feedback :rules="[
              { required: true, message: 'Please select type of feeds!' },
            ]">
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Amount of feed on a daily basis /chicken"
              name="amountOfFeedOnDailyBasisPerChicken" :rules="[
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Price of feed" name="priceOfFeedToBeDelivered" :rules="[
              {
                required: true,
                type: 'number',
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Amount Of Feed To Be Delivered"
              name="amountOfFeedToBeDelivered" :rules="[
                { required: true, message: 'Please input a valid number' },
              ]" validate-trigger="onBlur">
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Supplier" name="supplierId"
              ...
              <a-select v-model:value="farmerForm.supplierId" :size="'middle'" placeholder="Please select">
                ...
                <a-select-option v-for="supplier in suppliers" :value="supplier.key" :key="supplier.key">{{
                  supplier.label + " / " + supplier.telephone }}
                </a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Date of payment" name="dateOfPayment"
              :rules="[{ required: true }]">
              <a-date-picker class="input" :disabledDate="disabledPastDates" v-model:value="farmerForm.dateOfPayment" />
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
        ...
        <a-row :gutter="16">
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Full Name" name="fullName"
              ...
              <a-input class="input" placeholder="Please enter  full name" v-model:value="nextOfKinForm.fullName" />
            </a-form-item>
          </a-col>
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="Phone Number" name="telephone" :rules="[
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item class="label-input-height" label="National Id" name="nationalId" :rules="[
              ...
              <a-input class="input" placeholder="Enter a valid national Id" v-model:value="nextOfKinForm.nationalId" />
            </a-form-item>
          </a-col>
          <a-col :span="isSmallScreen ? 24 : 12">
...
const typeoffeeds = computed(() =>
  entitiesStore.typeoffeeds.map((el: any) => ({
    label: el.name.toUpperCase(),
    value: el.id,
  }))
);
...
watch(
  () => [
    farmerForm.value.amountOfFeedOnDailyBasisPerChicken,
    farmerForm.value.numberOfChicken,
  ],
  ([newPrice, newNumber]) => {
