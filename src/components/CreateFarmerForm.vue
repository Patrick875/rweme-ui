    ...
    <div v-else>
        ...
        <a-row :gutter="16">
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-input
                class="input"
                placeholder="Please enter farmer full name"
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-input
                class="input"
                placeholder="07-- --- ---"
                v-model:value="farmerForm.telephone"
              />
            </a-form-item>
          </a-col>
          <a-col :span="isSmallScreen ? 24 : 12">
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-input
                class="input"
                placeholder="Enter a valid national Id"
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-select
                v-model:value="farmerForm.provinceId"
                :size="'middle'"
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-select
                :disabled="!farmerForm.provinceId"
                v-model:value="farmerForm.districtId"
                :size="'middle'"
                placeholder="Please select !!"
                @popupScroll="popupScroll"
              >
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-select
                :disabled="!farmerForm.districtId"
                v-model:value="farmerForm.sectorId"
                :size="'middle'"
                placeholder="Please select !!"
                @popupScroll="popupScroll"
              >
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-select
                :disabled="!farmerForm.sectorId"
                v-model:value="farmerForm.cellId"
                :size="'middle'"
                placeholder="Please select !!"
                @popupScroll="popupScroll"
              >
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-select
                :disabled="!farmerForm.cellId"
                v-model:value="farmerForm.addressId"
                :size="'middle'"
                placeholder="Please select !!"
                @popupScroll="popupScroll"
              >
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-select
                v-model:value="farmerForm.chickenTypeId"
                :options="typeofchicken"
                :size="'middle'"
                placeholder="Please select !!"
                @popupScroll="popupScroll"
              ></a-select>
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item
              class="label-input-height"
              label="Chicken health condition"
            ...
            >
              <a-select
                v-model:value="farmerForm.chickenHealthCondition"
                :size="'middle'"
                placeholder="Please select"
                @popupScroll="popupScroll"
              >
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item
              name="hasInsurance"
              label="Has insurance for his/her chicken"
              has-feedback
              :rules="[{ required: true, message: 'Please select !' }]"
            >
              <a-select
                v-model:value="farmerForm.hasInsurance"
                :size="'middle'"
                placeholder="Please select type of Feeds"
                @popupScroll="popupScroll"
              >
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-select
                v-model:value="farmerForm.assignedTo"
                :size="'middle'"
                placeholder="Please select"
              >
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-select
                v-model:value="farmerForm.typeOfFeed"
                :options="typeoffeeds"
                :size="'middle'"
                placeholder="Please select type of Feeds"
                @popupScroll="popupScroll"
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item
              class="label-input-height"
              label="Amount of feed on a daily basis /chicken"
            ...
            >
              <a-input-number
                class="input"
                placeholder="Enter a valid number 0.00"
                :step="0.01"
                :min="1"
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-input-number
                ...
                placeholder="Enter a valid number 0.00"
                @blur="validateAmount"
                v-model:value="farmerForm.priceOfFeedToBeDelivered"
                :step="0.01"
              />
            </a-form-item>
          </a-col>
          <a-col :span="isSmallScreen ? 24 : 12">
            <a-form-item
              class="label-input-height"
              label="Amount Of Feed To Be Delivered"
            ...
            >
              <a-input-number
                ...
                placeholder="Enter a valid number 0.00"
                @blur="validateAmount"
                v-model:value="farmerForm.amountOfFeedToBeDelivered"
              />
            </a-form-item>
          </a-col>
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-select
                v-model:value="farmerForm.supplierId"
                :size="'middle'"
                placeholder="Please select"
              >
                <a-select-option disabled value=""
                  >Select supplier</a-select-option
                >
                <a-select-option
          ...
          <a-col :span="isSmallScreen ? 24 : 12">
            ...
            >
              <a-input
                class="input"
                placeholder="07-- --- ---"
                v-model:value="nextOfKinForm.telephone"
              />
            </a-form-item>
          </a-col>
          <a-col :span="isSmallScreen ? 24 : 12">
      ...
      <div class="double-form-btn g-flex">
        <a-button
          ...
          >CANCEL</a-button
        >
        <a-button :loading="loading" class="btn-auth" @click="createFarmer"
          >CREATE FARMER</a-button
        >
      </div>
    </div>
  </div>
...
<script lang="ts" setup>
  ...
  const nationalIdPatern =
    /^[12](19[0-9]{2}|20[0-9]{2}|2100)[78]00[0-9]{5}[1-3][1-9]{2}$/;
