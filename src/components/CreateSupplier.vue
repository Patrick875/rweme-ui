      ...
      <a-row :gutter="16">
        <a-col :span="isSmallScreen ? 24 : 12">
          <a-form-item
            ...
            name="fullName"
            :rules="[
              { required: true, message: 'Please input supplier full name!' },
            ]"
          >
            <a-input
              class="input"
              placeholder="Please enter supplier full name"
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-input
              class="input"
              placeholder="07-- --- ---"
              v-model:value="supplierForm.telephone"
            />
          </a-form-item>
        </a-col>
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-input
              ...
              v-model:value="supplierForm.email"
            />
          </a-form-item>
        </a-col>
        <a-col :span="isSmallScreen ? 24 : 12">
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              v-model:value="supplierForm.typeOfFeedIds"
              :options="typesOfFeed"
              mode="multiple"
              :size="'middle'"
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-input
              class="input"
              placeholder="Enter a valid momoPay"
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              v-model:value="supplierForm.provinceId"
              :size="'middle'"
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!supplierForm.provinceId"
              v-model:value="supplierForm.districtId"
              :size="'middle'"
              placeholder="Please select !!"
              @popupScroll="popupScroll"
            >
              <a-select-option
                v-for="district in districts.filter(
                  (distr) => distr.provinceId === supplierForm.provinceId
                )"
                :key="district.id"
                :value="district.key"
              >
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!supplierForm.districtId"
              v-model:value="supplierForm.sectorId"
              :size="'middle'"
              placeholder="Please select !!"
              @popupScroll="popupScroll"
            >
              <a-select-option
                v-for="sector in sectors.filter(
                  (sect) => sect.districtId === supplierForm.districtId
                )"
                :key="sector.id"
                :value="sector.key"
              >
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!supplierForm.sectorId"
              v-model:value="supplierForm.cellId"
              :size="'middle'"
              placeholder="Please select !!"
              @popupScroll="popupScroll"
            >
              <a-select-option
                v-for="cell in cells.filter(
                  (cell) => cell.sectorId === supplierForm.sectorId
                )"
                :key="cell.id"
                :value="cell.key"
              >
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!supplierForm.cellId"
              v-model:value="supplierForm.addressId"
              :size="'middle'"
              placeholder="Please select !!"
              @popupScroll="popupScroll"
            >
              <a-select-option
                v-for="village in villages.filter(
                  (vill) => vill.cellId === supplierForm.cellId
                )"
                :key="village.id"
                :value="village.key"
              >
      ...
      <a-form-item>
        <div class="double-form-btn g-flex">
          <a-button
            ...
            >CANCEL</a-button
          >
          <a-button :loading="loading" class="btn-auth" html-type="submit"
