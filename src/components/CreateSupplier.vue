      ...
      <a-row :gutter="16">
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          <a-form-item class="label-input-height" label="National Id" name="nationalId" :rules="[
            ...
            <a-input class="input" placeholder="Enter a valid national Id" v-model:value="supplierForm.nationalId" />
          </a-form-item>
        </a-col>
        <a-col :span="isSmallScreen ? 24 : 12">
          <a-form-item name="typeOfFeedIds" label="Select type of feeds" has-feedback :rules="[
            { required: true, message: 'Please select type of feeds!' },
          ]">
            <a-select v-model:value="supplierForm.typeOfFeedIds" :options="typesOfFeed" mode="multiple" :size="'middle'"
              placeholder="Please select types of feed" @popupScroll="popupScroll">
            </a-select>
          </a-form-item>
        </a-col>
        <a-col :span="isSmallScreen ? 24 : 12">
          <a-form-item class="label-input-height" label="MOMO Pay Code" name="momoPay" :rules="[
            ...
            <a-input class="input" placeholder="Enter a valid momoPay" v-model:value="supplierForm.momoPay" />
          </a-form-item>
        </a-col>
        <a-col :span="isSmallScreen ? 24 : 12">
