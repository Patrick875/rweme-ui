      ...
      <a-row :gutter="[16, 16]">
        <a-col :span="isSmallScreen ? 24 : 12">
          <a-form-item class="label-input-height" label="Status" name="status">
            <a-select
              v-model:value="vetFilterForm.status"
              :size="'middle'"
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              v-model:value="vetFilterForm.specializations"
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              v-model:value="vetFilterForm.province"
              :size="'middle'"
              placeholder="Please select !!"
            >
              <a-select-option value="">---</a-select-option>
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!vetFilterForm.province"
              v-model:value="vetFilterForm.district"
              :size="'middle'"
              placeholder="Please select !!"
            >
              <a-select-option value="">---</a-select-option>
              ...
              <a-select-option
                v-for="district in districts.filter(
                  (distr) => distr.provinceId === vetFilterForm.province
                )"
                :key="district.id"
                :value="district.key"
              >
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!vetFilterForm.district"
              v-model:value="vetFilterForm.vetSector"
              :size="'middle'"
              placeholder="Please select !!"
            >
              <a-select-option value="">---</a-select-option>
              ...
              <a-select-option
                v-for="sector in sectors.filter(
                  (sect) => sect.districtId === vetFilterForm.district
                )"
                :key="sector.id"
                :value="sector.key"
              >
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          <a-form-item class="label-input-height" label="Cell" name="cell">
            <a-select
              :disabled="!vetFilterForm.vetSector"
              v-model:value="vetFilterForm.cell"
              :size="'middle'"
              placeholder="Please select !!"
            >
              <a-select-option value="">---</a-select-option>
              ...
              <a-select-option
                v-for="cell in cells.filter(
                  (cell) => cell.sectorId === vetFilterForm.vetSector
                )"
                :key="cell.id"
                :value="cell.key"
              >
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!vetFilterForm.cell"
              v-model:value="vetFilterForm.village"
              :size="'middle'"
              placeholder="Please select !!"
            >
              <a-select-option value="">---</a-select-option>
              <a-select-option
                v-for="village in villages.filter(
                  (vill) => vill.cellId === vetFilterForm.cell
                )"
                :key="village.id"
                :value="village.key"
              >
...
<script setup lang="ts">
  ...
  const filter = async () => {
    ...
    const cleanFilterObj = Object.keys(vetFilterForm.value).reduce(
      (acc, key) => {
        if (
          vetFilterForm.value[key] != undefined &&
          vetFilterForm.value[key] != null &&
          vetFilterForm.value[key] != ""
        ) {
          if (
            key === "specializations" &&
            vetFilterForm.value[key].length == 0
          ) {
            acc = acc;
          } else {
