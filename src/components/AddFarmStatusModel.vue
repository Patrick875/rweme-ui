<template>
  <div>
    <Modal
      :isOpen="props.isToggleAddStatusModal"
      @modal-close="props.cancelButton"
      mainHeader="RECORD FARM STATUS"
          ...
          <a-row :gutter="[16, 16]">
            <a-col :span="isSmallScreen ? 24 : 12">
              ...
              >
                ...
                >
                  <a-select-option
                    v-for="(farmer, index) in vetFarmers"
                    :key="index"
                    :value="farmer.key"
                  >
                    {{ farmer.fullName }}
            ...
            <a-col :span="isSmallScreen ? 24 : 12">
              ...
              >
                <a-input
                  class="input"
                  type="number"
                  placeholder="Enter the number of chicken"
            ...
            <a-col :span="isSmallScreen ? 24 : 12">
              <a-form-item
                class="label-input-height"
                label="Amount of feed on daily basis per chicken"
                name="amountOfFeedOnDailyBasisPerChicken"
                :rules="[
                  { message: 'Please fill in the amount of daily feed !' },
                ]"
              >
                <a-input
                  class="input"
                  type="number"
                  placeholder="Amount of feed/chicken/day"
            ...
            <a-col :span="isSmallScreen ? 24 : 12">
              <a-form-item
                class="label-input-height"
                label="Has insurance for chicken"
                name="hasInsurance"
                :rules="[{ message: 'Please input select !!' }]"
              >
                <a-select
                  v-model:value="farmStatus.hasInsurance"
                  :size="'middle'"
            ...
            <a-col :span="isSmallScreen ? 24 : 12">
              ...
              >
                <a-select
                  v-model:value="farmStatus.chickenHealthCondition"
                  :size="'middle'"
                  placeholder="Please select"
                >
...
<script setup lang="ts">
  ...
  const vetFarmers = computed(() =>
    props.byVeternary
      ? entitiesStore.vetFarmers?.map((el) => ({
          label: el.fullName,
          key: el.id,
          ...el,
        }))
  ...
  const addStatus = async () => {
    ...
    const submitData = {
      ...farmStatus,
      farmerId: props.farmerId ? props.farmerId : farmStatus.farmerId,
      chickenTypeId: props.chickenTypeId,
    };
    try {
