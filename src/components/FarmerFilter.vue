            ...
            <a-row :gutter="[16, 16]">
                <a-col :span="isSmallScreen ? 24 : 12">
                    <a-form-item class="label-input-height" label="Status" name="status">
                        <a-select v-model:value="farmerFilterForm.status" :size="'middle'"
                ...
                <a-col :span="isSmallScreen ? 24 : 12">
                    <a-form-item class="label-input-height" label="Chicken type" name="typeOfChicken">
                        <a-select v-model:value="farmerFilterForm.typeOfChicken" :size="'middle'"
                            placeholder="Please select !!">
                            <a-select-option value="">---</a-select-option>
                ...
                <a-col :span="isSmallScreen ? 24 : 12">
                    <a-form-item class="label-input-height" label="Number of chicken" name="Number of chicken">
                        <a-select v-model:value="farmerFilterForm.numberOfChicken" :size="'middle'"
                            placeholder="Please select !!">
                            <a-select-option value="">---</a-select-option>
                ...
                <a-col :span="isSmallScreen ? 24 : 12">
                    <a-form-item class="label-input-height" label="Assigned Veternary" name="assignedTo"
                        ...
                        <a-select v-model:value="farmerFilterForm.assignedTo" :size="'middle'"
                            placeholder="Please select">
                ...
                <a-col :span="isSmallScreen ? 24 : 12">
                    <a-form-item class="label-input-height" label="Province" name="province">
                        <a-select v-model:value="farmerFilterForm.province" :size="'middle'"
                            placeholder="Please select !!">
                            <a-select-option value="">---</a-select-option>
                ...
                <a-col :span="isSmallScreen ? 24 : 12">
                    <a-form-item class="label-input-height" label="District" name="district">
                        <a-select :disabled="!farmerFilterForm.province" v-model:value="farmerFilterForm.district"
                            :size="'middle'" placeholder="Please select !!">
                            <a-select-option value="">---</a-select-option>

                            <a-select-option
                                v-for="district in districts.filter((distr) => distr.provinceId === farmerFilterForm.province)"
                ...
                <a-col :span="isSmallScreen ? 24 : 12">
                    <a-form-item class="label-input-height" label="Sector" name="farmerSector">
                        <a-select :disabled="!farmerFilterForm.district" v-model:value="farmerFilterForm.farmerSector"
                            :size="'middle'" placeholder="Please select !!">
                            <a-select-option value="">---</a-select-option>

                            <a-select-option
                                v-for="sector in sectors.filter((sect) => sect.districtId === farmerFilterForm.district)"
                ...
                <a-col :span="isSmallScreen ? 24 : 12">
                    <a-form-item class="label-input-height" label="Cell" name="cell">
                        <a-select :disabled="!farmerFilterForm.farmerSector" v-model:value="farmerFilterForm.cell"
                            :size="'middle'" placeholder="Please select !!">
                            <a-select-option value="">---</a-select-option>

                            <a-select-option
                                v-for="cell in cells.filter((cell) => cell.sectorId === farmerFilterForm.farmerSector)"
                ...
                <a-col :span="isSmallScreen ? 24 : 12">
                    <a-form-item class="label-input-height" label="Village" name="address">
                        <a-select :disabled="!farmerFilterForm.cell" v-model:value="farmerFilterForm.village"
                            :size="'middle'" placeholder="Please select !!">
                            <a-select-option value="">---</a-select-option>
                            <a-select-option
                                v-for="village in villages.filter((vill) => vill.cellId === farmerFilterForm.cell)"
...
const filter = async () => {
    ...
    const cleanFilterObj = Object.keys(farmerFilterForm.value).reduce((acc, key) => {
        if (farmerFilterForm.value[key] != undefined && farmerFilterForm.value[key] != null && farmerFilterForm.value[key] != '') {
            if (key === 'numberOfChicken') {
                const { min, max } = getMinAndMaxChicken(farmerFilterForm.value[key])
