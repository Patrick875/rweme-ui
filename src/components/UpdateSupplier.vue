      ...
      <a-row :gutter="16">
        <a-col :span="isSmallScreen ? 24 : 12">
          <a-form-item
            ...
            name="fullName"
            :rules="[
              { required: true, message: 'Please input suppluer full name!' },
            ]"
          >
            <a-input
              class="input"
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              v-model:value="veternaryForm.typeoffeeds"
              :options="typeoffeeds"
              mode="multiple"
              :size="'middle'"
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              v-model:value="veternaryForm.provinceId"
              :size="'middle'"
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!veternaryForm.provinceId"
              v-model:value="veternaryForm.districtId"
              :size="'middle'"
              placeholder="Please select !!"
              @popupScroll="popupScroll"
            >
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!veternaryForm.districtId"
              v-model:value="veternaryForm.sectorId"
              :size="'middle'"
              placeholder="Please select !!"
              @popupScroll="popupScroll"
            >
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!veternaryForm.sectorId"
              v-model:value="veternaryForm.cellId"
              :size="'middle'"
              placeholder="Please select !!"
              @popupScroll="popupScroll"
            >
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              :disabled="!veternaryForm.cellId"
              v-model:value="veternaryForm.addressId"
              :size="'middle'"
              placeholder="Please select !!"
              @popupScroll="popupScroll"
            >
