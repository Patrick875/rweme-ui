      ...
      <a-row :gutter="16">
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-input
              class="input"
              placeholder="Please enter veternary full name"
        ...
        <a-col :span="isSmallScreen ? 24 : 12">
          ...
          >
            <a-select
              v-model:value="veternaryForm.specializationIds"
              :options="specializations"
              mode="multiple"
              :size="'middle'"
              placeholder="Please select specializations"
